...
% natbib removed; citations handled by pandoc CSL
...
% Bibliography style handled by pandoc CSL



% float package for H figure placement
\usepackage{float}
...
\newenvironment{CSLReferences}[2] % #1 hanging-ident, #2 entry spacing
 {% don't indent paragraphs
  ...
  % pandoc 3.x uses \bibitem inside CSLReferences; neutralise it
...
% bibliography placed in body via pandoc CSL
