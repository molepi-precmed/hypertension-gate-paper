...
As illustrated in Figure \ref{fig:corrplot.pqtls}, the GATE scores were relatively uncorrelated, suggesting that these genes are not linked by a shared biological pathway. This is consistent with the minimal sharing of _trans_ pQTLs observed between these genes (Supplementary Table \ref{tab:transpqtls} and Supplementary Figure \ref{fig:gwas.clump.graph.pqtl}).
...
if (params$output_format == "pdf") {
  ...
  table.data[, `:=`(p_trans=NULL, p_cis=NULL)],
             ...
             col.names=c("pQTL study", "Gene", "Chr", "Start position (Mb)",
                         ...
                         "$P$ value",
                         "Reported GWAS hit"),
             caption=("Putative core genes were defined by an association $P < 10^{-5}$ and minimum of twenty effective \\textit{trans} pQTLs contributing to the pGATE score."),
...
**Fig 3. Heatmap of pairwise correlations among pGATE scores for putative core proteins in MAP, arranged by hierarchical clustering.**
